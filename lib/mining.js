...
import { getActiveRentalHashrate } from './hardware.js';
...
export const calculateAccumulatedMiningReward = async (userId) => {
  ...
  // ✅ Añadir hashrate de contratos de hardware activos (rentals)
  totalHashrate += await getActiveRentalHashrate(userId);
