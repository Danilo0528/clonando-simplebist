...
import { applyLevelMultiplier, grantActivityXp } from './progression';
...
import { getLevelMultiplier } from './progression';

// ... (código hasta la función)
...
export const claimFaucet = async (userId) => {
  ...
  const updatedUser = await prisma.$transaction(async (tx) => {
    ...
    await creditTokens(userId, rewardAmount, tx);
    
    // Update last faucet claim time
